...
namespace CoronaData.Migrations
{
    ...
    [Migration("20200922072523_Type naar eigen tabel")]
    partial class Typenaareigentabel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoronaData.Models.Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoronaData.Models.Product", b =>
                {
                    b.HasOne("CoronaData.Models.Type", "Type")
                        .WithMany("Producten")
